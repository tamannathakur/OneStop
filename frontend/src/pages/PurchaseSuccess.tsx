      ...
      <div className="container max-w-lg mx-auto py-12">
        <Card className="text-center">
          <CardHeader className="pb-4">
            ...
            <CardTitle className="text-3xl font-bold">Purchase Successful!</CardTitle>
          </CardHeader>
          <CardContent className="pb-4">
            <p className="text-muted-foreground mb-6">
              Your purchase has been completed successfully. You will receive a confirmation email with your order details shortly.
            </p>
